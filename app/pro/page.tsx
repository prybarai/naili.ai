 ...
 return (
  <div className="relative z-10 bg-canvas">
   ...
   <section className="relative overflow-hidden px-4 pb-12 pt-20 sm:px-6 sm:pb-20 sm:pt-28 md:px-10 md:pt-36">
    ...
    <div className="absolute inset-0 -z-10 bg-gradient-to-b from-canvas-200 via-canvas-50 to-canvas-50" />

    <div className="mx-auto max-w-7xl">
     <div className="grid items-center gap-8 lg:grid-cols-2 lg:gap-16">
      {/* Text */}
      <div>
       <div className="mb-4 sm:mb-6 inline-flex items-center gap-2 rounded-full border border-hairline bg-canvas-50 px-3 py-1.5 shadow-soft">
        <div className="h-2 w-2 rounded-full bg-emerald-500 animate-pulse" />
        <span className="text-xs font-semibold uppercase tracking-wider text-ink-500">For contractors</span>
       </div>

       <h1 className="text-3xl font-bold leading-tight tracking-tight text-ink sm:text-4xl md:text-5xl lg:text-[3.25rem]">
       ...
       <p className="mt-4 sm:mt-6 text-base sm:text-lg leading-relaxed text-ink-500 max-w-xl">
       ...
       <div className="mt-6 sm:mt-8 flex flex-col sm:flex-row items-stretch sm:items-center gap-3">
        <Link
         href="#access"
         className="flex items-center justify-center gap-2 rounded-xl bg-ink px-6 py-3.5 text-base font-semibold text-canvas-50 shadow-lg transition hover:opacity-90 hover:shadow-xl active:scale-95"
        >
         Request early access
         <ArrowRight className="h-4 w-4" />
        </Link>
        <span className="text-sm text-ink-400 text-center sm:text-left">Free during launch — no lead fees.</span>
       </div>

       {/* Stats row */}
       <div className="mt-8 sm:mt-10 grid grid-cols-3 gap-3 sm:gap-4">
        {STATS.map((stat) => (
         <div key={stat.label} className="rounded-xl border border-hairline bg-canvas-50 p-3 sm:p-4 text-center shadow-soft">
          <p className="text-xl sm:text-2xl font-bold text-ink">{stat.value}</p>
          <p className="mt-0.5 text-xs sm:text-sm font-medium text-ink-600">{stat.label}</p>
          <p className="text-[10px] sm:text-xs text-ink-400">{stat.desc}</p>
         </div>
        ))}
       </div>
      </div>
      ...
      <div className="relative order-first lg:order-last">
       <div className="relative overflow-hidden rounded-2xl sm:rounded-3xl border border-hairline shadow-xl">
        <Image
        ...
        />
        {/* Overlay badge */}
        <div className="absolute bottom-3 left-3 sm:bottom-4 sm:left-4 flex items-center gap-2 rounded-xl bg-canvas-50/90 backdrop-blur-sm px-3 py-2 shadow-lg">
         <TrendingUp className="h-4 w-4 text-emerald-600" />
         <div>
          <p className="text-xs font-semibold text-ink">Growing network</p>
          <p className="text-[10px] text-ink-500">Expanding region by region</p>
         </div>
        </div>
       </div>
      </div>
   ...
   <section className="px-4 py-12 sm:px-6 sm:py-16 md:px-10 md:py-20">
    <div className="mx-auto max-w-7xl">
     <div className="mb-8 sm:mb-10 text-center">
      <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold tracking-tight text-ink">
       Why pros choose Naili
      </h2>
      <p className="mt-2 sm:mt-3 text-sm sm:text-base text-ink-500 max-w-2xl mx-auto">
     ...
     <div className="grid gap-4 sm:gap-5 md:grid-cols-3">
      {BENEFITS.map((item) => (
       <div
        key={item.title}
        className="rounded-2xl border border-hairline bg-canvas-50 p-5 sm:p-6 shadow-soft transition-all duration-300 hover:-translate-y-1 hover:shadow-lift"
       >
        <div className={`inline-flex h-11 w-11 sm:h-12 sm:w-12 items-center justify-center rounded-xl ${item.color}`}>
         <item.icon className="h-5 w-5 sm:h-6 sm:w-6" />
        </div>
        <h3 className="mt-3 sm:mt-4 text-lg font-bold text-ink">
         {item.title}
        </h3>
   ...
   {/* How it works */}
   <section className="px-4 py-12 sm:px-6 sm:py-16 md:px-10 md:py-20 bg-canvas-50">
    <div className="mx-auto max-w-7xl">
     <div className="mb-8 sm:mb-10">
      <div className="inline-flex items-center gap-2 rounded-full border border-hairline bg-canvas-50 px-3 py-1.5 mb-3 sm:mb-4">
       <Clock className="h-3.5 w-3.5 text-ink-400" />
       <span className="text-xs font-semibold uppercase tracking-wider text-ink-500">How the network works</span>
      </div>
      <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold tracking-tight text-ink">
       Homeowner first, contractor-ready when it matters.
      </h2>
      <p className="mt-2 sm:mt-3 text-sm sm:text-base text-ink-500 max-w-2xl">
     ...
     <div className="grid gap-4 sm:gap-5 md:grid-cols-3">
      {STEPS.map((step) => (
       <div key={step.num} className="relative rounded-2xl border border-hairline bg-canvas-50 p-5 sm:p-6">
        <div className="flex items-center gap-3 mb-3">
         <div className="flex h-10 w-10 items-center justify-center rounded-xl bg-ink text-canvas-50">
          <step.icon className="h-5 w-5" />
         </div>
         <span className="text-xs font-bold uppercase tracking-wider text-ink-400">{step.num}</span>
        </div>
   ...
   <section className="px-4 py-12 sm:px-6 sm:py-16 md:px-10 md:py-20">
    <div className="mx-auto max-w-7xl">
     <div className="rounded-2xl sm:rounded-3xl border border-hairline bg-canvas-50 p-5 sm:p-8 md:p-10 shadow-soft">
      ...
      <p className="mt-2 sm:mt-3 text-sm sm:text-base text-ink-500 max-w-3xl">
      ...
      <div className="mt-6 sm:mt-8 grid gap-4 sm:grid-cols-2">
       <div className="rounded-xl border border-hairline bg-canvas-50 p-4 sm:p-5">
        <div className="flex items-center gap-2 mb-2">
         ...
         <span className="text-xs font-bold uppercase tracking-wider text-ink-400">What we avoid</span>
        </div>
        <h3 className="text-base sm:text-lg font-bold text-ink">Marketplace spam</h3>
       ...
       <div className="rounded-xl border border-hairline bg-canvas-50 p-4 sm:p-5">
        <div className="flex items-center gap-2 mb-2">
         ...
         <span className="text-xs font-bold uppercase tracking-wider text-ink-400">What homeowners feel</span>
        </div>
        <h3 className="text-base sm:text-lg font-bold text-ink">Clear before contact</h3>
        <p className="mt-1.5 text-sm leading-relaxed text-ink-500">
   ...
   <section className="px-4 py-12 sm:px-6 sm:py-16 md:px-10 md:py-20 bg-canvas-50">
    <div className="mx-auto max-w-7xl">
     <div className="rounded-2xl sm:rounded-3xl bg-gradient-to-br from-graphite to-graphite-800 p-6 sm:p-8 md:p-10 text-canvas-50">
      <div className="grid items-center gap-6 lg:grid-cols-[1.2fr_1fr]">
       <div>
        ...
        <a
         ...
         className="mt-5 sm:mt-6 inline-flex items-center gap-2 rounded-xl bg-canvas-50 px-5 py-3 text-base font-semibold text-ink shadow-lg transition hover:bg-canvas-100 active:scale-95"
        >
         Explore Prybar.ai
   ...
   <section className="px-4 py-12 sm:px-6 sm:py-16 md:px-10 md:py-20 bg-canvas-50">
    <div className="mx-auto max-w-7xl">
     <div className="mx-auto max-w-2xl text-center mb-8 sm:mb-10">
      ...
      <p className="mt-2 sm:mt-3 text-sm sm:text-base text-ink-500 max-w-lg mx-auto">
        Priority lead matching, Prybar.ai integration, and premium features for serious contractors.
      </p>
     </div>

     <div className="mx-auto max-w-md">
      <div className="rounded-2xl sm:rounded-3xl border-2 border-amber-200 bg-canvas-50 p-6 sm:p-8 shadow-lg relative">
       <div className="absolute -top-3 left-1/2 -translate-x-1/2 inline-flex items-center gap-1 rounded-full bg-gradient-to-r from-amber-500 to-amber-400 px-4 py-1 text-xs font-bold uppercase tracking-wider text-ink shadow-md">
        <Sparkles className="h-3 w-3" /> Most popular
       </div>

       <div className="text-center mb-6 pt-4">
        <p className="text-4xl sm:text-5xl font-bold text-ink">
          $29<span className="text-lg sm:text-xl font-medium text-ink-400">/mo</span>
        </p>
        <p className="mt-1 text-sm text-ink-500">Cancel anytime</p>
       </div>
    ...
    <div className="mx-auto max-w-7xl">
     ...
     <div className="grid gap-4 sm:gap-5 md:grid-cols-2">
      {CONTRACTOR_FAQS.map((faq) => (
       <div
        key={faq.question}
        className="rounded-2xl border border-hairline bg-canvas-50 p-5 sm:p-6 shadow-soft"
       >
   ...
   {/* CTA — Signup Form */}
   <section id="access" className="px-4 py-12 sm:px-6 sm:py-16 md:px-10 md:py-20 bg-canvas-50">
    <div className="mx-auto max-w-7xl">
     <div className="grid gap-8 lg:grid-cols-[1fr_1.2fr] lg:items-start">
      ...
      <div className="lg:sticky lg:top-28">
       ...
       <p className="mt-2 sm:mt-3 text-sm sm:text-base text-ink-500 max-w-lg">
      ...
      {/* Right — form */}
      <div className="rounded-2xl sm:rounded-3xl border border-hairline bg-canvas-50 p-5 sm:p-6 md:p-8 shadow-soft">
