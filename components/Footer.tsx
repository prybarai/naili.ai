...
export default function Footer() {
  ...
  return (
    <footer
      className={cn(
        "relative z-10 border-t px-4 py-8 sm:px-6 sm:py-10 md:px-10",
        isPro
    ...
    >
      <div className="mx-auto flex max-w-7xl flex-col items-start justify-between gap-6 md:flex-row md:items-center">
        ...
        <div className="flex flex-wrap items-center gap-x-5 gap-y-2 text-sm">
          ...
          <Link href="/my-projects" className="transition hover:text-white">My Projects</Link>
          <Link href="/get-quotes" className="transition hover:text-white">Get Quotes</Link>
          <Link href="/pro" className="transition hover:text-white">For Pros</Link>
