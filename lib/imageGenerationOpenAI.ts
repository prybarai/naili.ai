...
const PRESERVATION_INSTRUCTIONS: Record<string, string> = {
  kitchen: `CRITICAL: You are editing a PHOTO of a real kitchen. You MUST change ONLY the following: cabinets, countertops, backsplash, and hardware. 
...
The result must look like a real contractor's "after" photo taken from the exact same angle, position, and lighting as the original photo.`,
  ...
  bathroom: `CRITICAL: You are editing a PHOTO of a real bathroom. You MUST change ONLY the following: tile (floor and wall), vanity, toilet, and fixtures. 
...
The result must look like a real contractor's "after" photo taken from the exact same angle and position as the original photo.`,
  ...
  flooring: `CRITICAL: You are editing a PHOTO of a room. You MUST change ONLY the floor surface. 
...
The result must look like a real before/after flooring installation photo taken from the exact same angle.`,
  ...
  interior_paint: `CRITICAL: You are editing a PHOTO of a room. You MUST change ONLY the paint color on the walls and trim. 
...
The result must look like a real before/after painting photo taken from the exact same angle.`,
  ...
  roofing: `CRITICAL: You are editing a PHOTO of a house. You MUST change ONLY the roof surface and roofing materials. 
...
The result must look like a real roofing contractor's "after" photo of the exact same house.`,
  ...
  exterior_paint: `CRITICAL: You are editing a PHOTO of a house. You MUST change ONLY the paint color of the siding, body, trim, and requested accent details.
...
The final result must follow the requested body, trim, and accent colors exactly and look like a real contractor's after photo of the same house.`,
  ...
  deck_patio: `CRITICAL: You are editing a PHOTO of a property. You MUST add or update ONLY the deck or patio area as requested.
...
The result must look like a real deck contractor's "after" photo.`,
  ...
  landscaping: `CRITICAL: You are editing a PHOTO of a property with landscaping. You MUST transform ONLY the lawn, garden beds, shrubs, and plantings.
...
The result must look like a real landscaping contractor's "after" photo.`,
  ...
  custom_project: `CRITICAL: You are editing a PHOTO of a property. Apply ONLY the exact requested design update described by the homeowner.
